...
export default function WebinarCard({ webinar }: Props) {
  ...
  return (
    <div className="bg-white p-8 rounded-4xl border border-gray-200 space-y-5">
      <Badge className="bg-[#8376FF] border border-gray-300 p-2 rounded-lg">
        {badge}
      </Badge>
      <h1 className="text-2xl font-bold">{title}</h1>
      <p className="font-medium max-w-lg">{description}</p>
